...
img_path = '/media/ds/WorkSpace/az_tr_1M/s_az/s1_az_10-AA-830_9.jpg'
...
noisy2mul_ = cv2.cvtColor(noisy2mul, cv2.COLOR_BGR2RGB)
cv2.imwrite("noise2.jpg", 255*noisy2mul)